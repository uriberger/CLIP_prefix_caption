...
venv2/bin/python train.py --data ./data/coco/es_base_train_data_${EXP_IND}.pkl --out_dir ${BASE_DIR}/output/exp_${EXP_IND}_base --epochs 20 --tokenizer ${MODEL_NAME} --gpt2_model ${MODEL_NAME}
echo "$MSG_PREFIX Base inference"
venv2/bin/python inference.py --image_path_file ${BASE_DIR}/data/test_data_${EXP_IND}.json --model_path ${BASE_DIR}/output/exp_${EXP_IND}_base/coco_prefix-019.pt --output_file ${BASE_DIR}/infer/base_infer_on_test_${EXP_IND} --gpt2_model ${MODEL_NAME}
...
venv2/bin/python train.py --data ${TRANSLATED_PICKLE_FILE} --out_dir ${BASE_DIR}/output/exp_${EXP_IND}_translated --epochs 5 --load_model_from_path ${BASE_DIR}/output/exp_${EXP_IND}_base/coco_prefix-019.pt --tokenizer ${MODEL_NAME} --gpt2_model ${MODEL_NAME}
...
venv2/bin/python inference.py --json_file ${BASE_DIR}/image_ids/coco_image_ids.json --model_path ${BASE_DIR}/output/exp_${EXP_IND}_base/coco_prefix-019.pt --output_file ${BASE_DIR}/infer/base_infer_on_additional_train_${EXP_IND} --dataset COCO --gpt2_model ${MODEL_NAME}
echo "$MSG_PREFIX Own data preperation"
venv2/bin/python ${BASE_DIR}/convert_to_training_data.py ${BASE_DIR}/infer/base_infer_on_additional_train_${EXP_IND}.json ${BASE_DIR}/data/own_train_data_${EXP_IND}.json
...
venv2/bin/python train.py --data ./data/coco/coco_es_own_data_${EXP_IND}.pkl --out_dir ${BASE_DIR}/output/exp_${EXP_IND}_own --epochs 5 --load_model_from_path ${BASE_DIR}/output/exp_${EXP_IND}_base/coco_prefix-019.pt --tokenizer ${MODEL_NAME} --gpt2_model ${MODEL_NAME}
...
venv2/bin/python train.py --data ./data/coco/coco_es_re_data_${EXP_IND}.pkl --out_dir ${BASE_DIR}/output/exp_${EXP_IND}_re --epochs 5 --load_model_from_path ${BASE_DIR}/output/exp_${EXP_IND}_base/coco_prefix-019.pt --tokenizer ${MODEL_NAME} --gpt2_model ${MODEL_NAME}
...
venv2/bin/python train.py --data ./data/coco/coco_es_mplug_re_data_${EXP_IND}.pkl --out_dir ${BASE_DIR}/output/exp_${EXP_IND}_mplug_re --epochs 5 --load_model_from_path ${BASE_DIR}/output/exp_${EXP_IND}_base/coco_prefix-019.pt --tokenizer ${MODEL_NAME} --gpt2_model ${MODEL_NAME}
