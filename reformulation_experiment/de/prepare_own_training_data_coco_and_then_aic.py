...
with open(f'reformulation_experiment/de/data/infer/coco_infer_on_aic_{sys.argv[1]}.json', 'r') as fp:
...
with open(f'reformulation_experiment/de/data/own_train_data/own_train_data_coco_and_then_aic_{sys.argv[1]}.json', 'w') as fp:
