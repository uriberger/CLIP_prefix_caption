...
with open(f'reformulation_experiment/de/data/infer/base_infer_on_aic_{sys.argv[1]}_reformulated.json', 'r') as fp:
...
with open(f'reformulation_experiment/de/data/re_train_data/reformulations_train_data_coco_aic_{sys.argv[1]}.json', 'w') as fp:
