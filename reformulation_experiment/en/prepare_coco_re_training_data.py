...
with open(f'{base_dir}/data/train_data/gt_train_data_{exp_ind}.json', 'r') as fp:
    gt_data = json.load(fp)
base_data = random.sample(gt_data, base_sample_num)
with open(f'{base_dir}/data/train_data/base_train_data_{exp_ind}.json', 'w') as fp:
...
with open(f'{base_dir}/data/train_data/additional_train_image_ids_{exp_ind}.json', 'w') as fp:
