...
MSG_PREFIX=[LOG_MSG]
BASE_DIR=reformulation_experiment/ja
EXP_IND=0
SAMPLE_NUM=20000
...
rm -f data/coco/stair_train_data_${EXP_IND}_tokens.pkl
venv2/bin/python parse_coco.py --clip_model_type ViT-B/32 --json_file ${BASE_DIR}/data/base_train_data/stair_train_data_${EXP_IND}.json --output_file stair_train_data_${EXP_IND}
...
venv2/bin/python train.py --data ./data/coco/stair_val_data_${EXP_IND}.pkl --out_dir ${BASE_DIR}/output/exp_${EXP_IND}_gt --epochs 5 --load_model_from_path ${BASE_DIR}/output/exp_${EXP_IND}_base/coco_prefix-009.pt --tokenizer rinna/japanese-gpt2-small --gpt2_model rinna/japanese-gpt2-small
echo "$MSG_PREFIX GT inference 1 epoch"
venv2/bin/python inference.py --dataset COCO --model_path ${BASE_DIR}/output/exp_${EXP_IND}_gt/coco_prefix-000.pt --split test --output_file ${BASE_DIR}/data/infer/gt_infer_on_test_${EXP_IND}_1_epoch --gpt2_model rinna/japanese-gpt2-small
echo "$MSG_PREFIX GT inference 5 epochs"
venv2/bin/python inference.py --dataset COCO --model_path ${BASE_DIR}/output/exp_${EXP_IND}_gt/coco_prefix-004.pt --split test --output_file ${BASE_DIR}/data/infer/gt_infer_on_test_${EXP_IND}_5_epoch --gpt2_model rinna/japanese-gpt2-small
