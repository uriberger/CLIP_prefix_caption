...
with open(f'reformulation_experiment/ja/data/infer/base_infer_on_val_{sys.argv[1]}_reformulated.json', 'r') as fp:
    data = json.load(fp)
...
with open(f'reformulation_experiment/ja/data/re_train_data/reformulations_train_data_{sys.argv[1]}.json', 'w') as fp:
